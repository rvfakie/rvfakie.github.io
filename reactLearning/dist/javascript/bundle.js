...
// then in component constructor
// this.state = this.props;

// <HashRouter>
// 	<Switch>
// 		<Route exact path='/create' render={(props) => (
// 		  <Content items={this.state.items} popupHandler={this.popupHandler} />
// 		)}/>
// 	</Switch>
// </HashRouter>
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(17),p=__webpack_require__(18);__webpack_require__(9);var r=__webpack_require__(6);
...
*/
var aa=__webpack_require__(0);__webpack_require__(9);var l=__webpack_require__(29),n=__webpack_require__(17),ba=__webpack_require__(30),ca=__webpack_require__(6),da=__webpack_require__(18),ea=__webpack_require__(31),fa=__webpack_require__(32),ha=__webpack_require__(35),ia=__webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_src_stylesheets_index_scss__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_src_stylesheets_index_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_src_stylesheets_index_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_src_javascript_components_Header__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_src_javascript_components_Content__ = __webpack_require__(68);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'app' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_src_javascript_components_Header__["a" /* default */], null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4_src_javascript_components_Content__["a" /* default */], null)
    );
  }
});
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	componentUpdateHandler() {
		let activeLink = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).getElementsByClassName('active-link')[0];
		let activeElement = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).getElementsByClassName('active-link-slidenut')[0];
		let activeLinkWidth = activeLink.offsetWidth;
		let activeLinkOffsetLeft = activeLink.offsetLeft;

		activeElement.style.width = activeLinkWidth + 'px';
		activeElement.style.left = activeLinkOffsetLeft + 'px';
	}
	...
	render() {
		let logoLinksTemplate, linksTemplate;

		logoLinksTemplate = this.logoLinks.map((item, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'li',
			{ key: index },
		...
		linksTemplate = this.links.map((item, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'li',
			{ key: index },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'div',
					{ className: 'header' },
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["b" /* NavLink */], { className: 'logo', to: '/' }),
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'ul',
						null,
						logoLinksTemplate
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'subheader-left-wrapper' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'ul',
							null,
							linksTemplate
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'subheader-right-wrapper' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
							'ul',
							null,
							__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'active-link-slidenut' })
				)
			)
		);
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Home__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Create__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Catalog__ = __webpack_require__(71);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	updateStateOfCreate(incomeState) {
		let state = this.state;
		state.stateOfCreate = incomeState;
		this.setState(state);
	}
	...
	render() {
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { exact: true, path: '/cat', render: props => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Catalog__["a" /* default */], { items: this.state.items }) }),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["c" /* Route */], { exact: true, path: '/create', render: props => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Create__["a" /* default */], { updateStateOfCreate: incomeState => this.updateStateOfCreate(incomeState), stateOfCreate: this.state.stateOfCreate }) })
			)
		);
	}
});
...
/* harmony default export */ __webpack_exports__["a"] = (() => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
		...
		__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "content-block-wrapper" })
));
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		...
		this.state = _extends({}, this.props.stateOfCreate);

		let categories = ['Автомобили', 'Спорт'];
		this.categories = categories;

		this.stepClassResolve = this.stepClassResolve.bind(this);
		this.continueClassResolve = this.continueClassResolve.bind(this);
	}
	...
	categoryClickHandler(catName) {
		let state = this.state;
		if (this.state.chosenCategory !== catName) {
			state.chosenCategory = catName;
			state.step = 2;
		} else {
	...
	continueClickHandler() {
		if (this.state.step !== 3) {
			if (!(this.state.step + 1 > 1 && !this.state.chosenCategory || this.state.step + 1 > 2 && !this.state.chosenPrice)) {
				let state = this.state;
	...
	priceChangeHandler(event) {
		let state = this.state;
		state.chosenPrice = event.target.value;
		this.setState(state);
	}

	stepClassResolve(stepToCheck) {
		if (this.state.step === stepToCheck) {
			return 'create-progress-step create-progress-step-active';
		} else {
			if (stepToCheck > 1 && !this.state.chosenCategory) {
				return 'create-progress-step disabled';
			} else if (stepToCheck > 2 && !this.state.chosenPrice) {
				return 'create-progress-step disabled';
			}
			return 'create-progress-step';
		}
	}
	continueClassResolve() {
		if (this.state.step !== 3) {
			if (this.state.step + 1 > 1 && !this.state.chosenCategory || this.state.step + 1 > 2 && !this.state.chosenPrice) {
				return 'btn-disabled';
			}
	...
	slidenutUpdate() {
		let active = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).getElementsByClassName('create-progress-step-active')[0];
		let slidenut = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).getElementsByClassName('create-progress-slidenut')[0];
		let activeWidth = active.offsetWidth;
		let activeOffsetLeft = active.offsetLeft;

		slidenut.style.width = activeWidth + 'px';
		slidenut.style.left = activeOffsetLeft + 'px';
	}
	...
	componentWillUnmount() {
		this.props.updateStateOfCreate(this.state);
	}
	...
	render() {
		...
		for (let i = 0; i < 3; i++) {
			stepProgress.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ key: i, onClick: () => this.stepClickHandler(i + 1), className: this.stepClassResolve(i + 1) },
				'\u0428\u0430\u0433 ',
				i + 1
			));
		}
		...
		let categoryTemplate = this.categories.map((catName, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			{
				key: index,
				className: this.state.chosenCategory === catName ? 'category-item chosen-category' : 'category-item',
				onClick: () => this.categoryClickHandler(catName) },
			catName
		));

		// Price select template
		let priceTemplate = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			null,
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'number', value: this.state.chosenPrice, onChange: this.priceChangeHandler.bind(this), placeholder: '\u0426\u0435\u043D\u0430' })
		);

		// Progress buttons template
		let prevButton = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			{
				onClick: () => this.stepClickHandler(this.state.step - 1 ? this.state.step - 1 : 1),
				className: this.state.step === 1 ? 'btn-disabled' : null },
			'\u041D\u0430\u0437\u0430\u0434'
		);
		let nextButton = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'div',
			{
				onClick: () => this.continueClickHandler(),
				className: this.continueClassResolve() },
			this.state.step === 3 ? 'Создать' : 'Продолжить'
		);

		switch (this.state.step) {
			case 1:
				stepHeader = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'h2',
					null,
					'\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u043A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u044E'
				);
				renderTemplate = categoryTemplate;
				break;
			case 2:
				stepHeader = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'h2',
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'div',
						{ className: 'create-progress-wrapper' },
						__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'create-progress-slidenut' }),
						stepProgress
					),
					stepHeader,
					renderTemplate,
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	render() {
		...
		if (this.props.items.length > 0) {
			template = this.props.items.map((item, index) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
			...
			template = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
